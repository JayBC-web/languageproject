...
const Login = props => {
  //meta title
  document.title = "DuoLearn | Login - Learn language through conversation with native speakers";
    ...
    <React.Fragment>
      ...
      <div className="home-btn d-none d-sm-block">
        <Link to="/" className="text-dark">
          <span className="logo-lg"> <img src={logoDark} alt="" height="43" /></span>
        </Link>
      </div>
                  ...
                  <div>
                    <Link to="/" className="auth-logo-light">
                      <div className="avatar-md profile-user-wid mb-4">
                        ...
                        <i className="bx bx-user-circle bx-lg text-dark" />
                        </span>
                      </div>
                    </Link>
                  </div>
